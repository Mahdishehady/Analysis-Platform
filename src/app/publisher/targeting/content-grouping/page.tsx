...
import AddCrad from "../segmentation/components/card";





export default function ContentGrouping() {
    ...
    <MainLayout>
      <div className="flex items-center justify-between space-y-2 py-3">
        <div className="flex items-center">
          ...
          <h2 className="text-lg  tracking-tight">Targeting {">"} Content Grouping</h2>
        </div>
      ...
      <div className="grid p-4 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <AddCrad input1={"Sports"} input2={"4 keywords"} input3={"12%"} />
        <AddCrad input1={"Users with high CRT"} input2={"10 keywords"} input3={"10%"} />
      </div>
